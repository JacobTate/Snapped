    ...
    <Container>
      <form action="/upload" method="POST" encType="multipart/form-data">
        ...
        <div className="custom-file mb-3">
          <input accept="image/x-png,image/gif,image/jpeg " type="file" name="file" id="file" className="custom-file-input" onChange={handleChange}></input>
          <label for="file" className="custom-file-label">{fileSelected.length >0? fileSelected : "Choose File"}</label>
        </div>
